...
export const DICT = {
  th: {
    ...
    super_heading: 'เงินที่นายจ้างเก็บให้ + เงินที่ได้คืนตอนกลับไทย',
    super_explainer: 'นายจ้างจ่ายเงินก้อนนี้เพิ่มให้อีก 12% จากค่าจ้าง โดยไม่หักจากเงินเดือนเรา ตอนกลับไทยขอคืนได้ แต่จะโดนหักภาษี 65%',
  ...
  en: {
    ...
    super_heading: 'Employer-paid fund + what you get back when leaving',
    super_explainer: 'Your employer adds this extra 12% on top of your wages, not from your paycheck. You can claim it when you leave Australia, but 65% tax is withheld.',
